...
" Credits:      Vim color scheme "paulsgetafe"
"
...
" magenta #470b1d   71  11  29
" peach   #fec275   254 194 117
...
hi String          guifg=#F8FFF9   guibg=#ffaaaa   gui=none            ctermfg=15      ctermbg=234
...
"————————————————————————————————————————————————————————————————————————————————————————————————————————————————————"
hi Constant        guifg=#F8FFF9   guibg=#1B1D1E   gui=none            ctermfg=15      ctermbg=234
hi String          guifg=#fec275   guibg=#470b1d   gui=none            ctermfg=224     ctermbg=52
hi Character       guifg=#F8FFF9   guibg=#1B1D1E   gui=none            ctermfg=15      ctermbg=234
hi Comment         guifg=#fec275   guibg=#2b3033   gui=none            ctermfg=224     ctermbg=237
